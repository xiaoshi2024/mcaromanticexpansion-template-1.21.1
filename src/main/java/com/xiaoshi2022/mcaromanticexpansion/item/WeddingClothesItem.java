...
public class WeddingClothesItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        tooltip.accept(Component.translatable("tooltip.mcaromanticexpansion.wedding_clothes.line1",
                cultureDisplay, genderDisplay));
        tooltip.accept(Component.translatable("tooltip.mcaromanticexpansion.wearable.curio"));
    }
}