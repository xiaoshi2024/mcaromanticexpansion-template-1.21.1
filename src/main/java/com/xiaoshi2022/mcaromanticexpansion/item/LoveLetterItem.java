...
public class LoveLetterItem extends Item {
    ...
    public static boolean isWritten(ItemStack stack) {
        ...
        return tag != null && tag.getBoolean(KEY_WRITTEN);
    }

    public static String getRecipient(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_RECIPIENT)) {
            return tag.getString(KEY_RECIPIENT);
        }
        return "";
    }
    ...
    public static String getSender(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_SENDER)) {
            return tag.getString(KEY_SENDER);
        }
        return "";
    }
    ...
    public static String getSenderUUID(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_SENDER_UUID)) {
            return tag.getString(KEY_SENDER_UUID);
        }
        return "";
    }
    ...
    public static String getMessage(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_MESSAGE)) {
            return tag.getString(KEY_MESSAGE);
        }
        return "";
    }
    ...
    public static boolean hasReply(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        return tag != null && tag.getBoolean(KEY_HAS_REPLY);
    }

    public static String getReplyMessage(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_REPLY_MESSAGE)) {
            return tag.getString(KEY_REPLY_MESSAGE);
        }
        return "";
    }
    ...
    public static String getReplySender(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_REPLY_SENDER)) {
            return tag.getString(KEY_REPLY_SENDER);
        }
        return "";
    }
    ...
    public static String getReplySenderUUID(ItemStack stack) {
        CompoundTag tag = stack.getTag();
        if (tag != null && tag.contains(KEY_REPLY_SENDER_UUID)) {
            return tag.getString(KEY_REPLY_SENDER_UUID);
        }
        return "";
    }
    ...
    public static boolean concealInItem(ItemStack letter, ItemStack container, Player player) {
        ...
        CompoundTag containerTag = container.getOrCreateTag();
    ...
    public static boolean hasConcealedLetter(ItemStack container) {
        ...
        return tag != null && tag.contains(KEY_CONCEALED_LETTER);
    }
    ...
    public static String getConcealedRecipient(ItemStack container) {
        CompoundTag tag = container.getTag();
        if (tag != null && tag.contains(KEY_CONCEALED_LETTER)) {
    ...
    public static ItemStack extractFromItem(ItemStack container) {
        CompoundTag tag = container.getTag();
        if (tag == null || !tag.contains(KEY_CONCEALED_LETTER)) return ItemStack.EMPTY;
