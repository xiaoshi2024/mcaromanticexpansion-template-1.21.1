...
public class HUDConfig {
    ...
    // 配置值
    private static ForgeConfigSpec.ConfigValue<String> hudPosition;
    private static ForgeConfigSpec.IntValue hudOffsetX;
    private static ForgeConfigSpec.IntValue hudOffsetY;
    private static ForgeConfigSpec.BooleanValue showDebug;

    // 自定义坐标
    private static ForgeConfigSpec.IntValue customX;
    private static ForgeConfigSpec.IntValue customY;
